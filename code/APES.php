...
class APES extends DataExtension
{
    ...
    public function getMailChimpUserGroupings()
    {
        ...
        if (empty($memberInformation['merges']['GROUPINGS'])) {
            return array();
        }
    ...
    {
        // Return cached value
        if (isset($this->owner->mcgroupdata)) {
            return $this->owner->mcgroupdata;
        }
    ...
    public function getMailChimpInformation()
    {
        ...
        // Return cached value
        if (isset($this->owner->mcdata)) {
            return $this->owner->mcdata;
        }
